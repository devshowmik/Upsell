        ...
        <div className="col">
            <div className="card text-capitalize rounded-0 p-3 h-100" >
                ...
                <div className="info">
                    ...
                    <input onClick={bookProduct} className='btn btn-success form-control rounded-0 text-capitalize' type="submit" value="Book now" data-bs-toggle="modal" data-bs-target="#exampleModal" />
                    <BookingModule />
                </div>
            </div>
        </div>
